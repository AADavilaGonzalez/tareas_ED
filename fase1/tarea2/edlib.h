...
#define flush() (leer_hasta('\n', stdin))

static bool caracter_en_string(char* str, char c) {
    while(*str!='\0') {
...
#define validar_int() (validar_int_en_rango(LLONG_MIN, LLONG_MAX))
#define validar_int_min(min) (validar_int_en_rango(min, LLONG_MAX))
#define validar_int_max(max) (validar_int_en_rango(LLONG_MIN, max))
...
#define validar_uint() (validar_uint_en_rango(0, ULLONG_MAX))
#define validar_uint_min(min) (validar_uint_en_rango(min, ULLONG_MAX))
#define validar_uint_max(max) (validar_uint_en_rango(0, max))
...
#define validar_float() (validar_float_en_rango(-LDBL_MAX, LDBL_MAX))
...
#define leer_string_con_lmax(buffer, lmax, lbuffer) (leer_string_con_longitud(buffer, 0, lmax, lbuffer))
#define leer_string_con_lmin(buffer, lmin, lbuffer) (leer_string_con_longitud(buffer, lmin, lbuffer-1, lbuffer))
#define leer_string(buffer, lbuffer) (leer_string_con_longitud(buffer, 0, lbuffer-1, lbuffer))
