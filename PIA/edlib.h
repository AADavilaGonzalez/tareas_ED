...
/*Llama a la funcion exit() desplegando antes un mensaje en la pantalla y
limpia la pantalla antes de concluir con la ejecucion del programa*/
#define exit_grafico(status, ...) \
do {\
    println(__VA_ARGS__);\
    flush();\
    clear();\
